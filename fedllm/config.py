...
if hostname == "Khais-MacBook-Pro.local" or hostname == "Khais-MBP.attlocal.net":  
    from fedllm.config_mac import *  
else:
    from fedllm.config_cuda import * 
...
DATASET_SELECTION = "fedllm" #fedllm #fedllm_test
...
def set_output_dir(path):
    ...
    return path
# Get the root project directory (the parent directory of fedllm)
